...
public class ImagesActivity extends AppCompatActivity {
    ...
    public void onLaunchCamera() { 
        ...
        if(Build.VERSION.SDK_INT >= Build.VERSION_CODES.N)
            intermediateProvider = FileProvider.getUriForFile(getApplicationContext(), BuildConfig.APPLICATION_ID+".fileprovider", photoFile);
        else
    ...
    private void onCropImage() {
        if(Build.VERSION.SDK_INT >= Build.VERSION_CODES.N) {
            ...
            if (size == 0) {
                ...
                resultProvider = FileProvider.getUriForFile(getApplicationContext(), BuildConfig.APPLICATION_ID+".fileprovider", photoFile);
    ...
    private void saveBitmapFileToIntermediate(Uri sourceUri) {
        try {
            ...
            if(Build.VERSION.SDK_INT >= Build.VERSION_CODES.N)
                intermediateProvider = FileProvider.getUriForFile(getApplicationContext(), BuildConfig.APPLICATION_ID+".fileprovider", imageFile);
            else
    ...
    public File getPhotoFileUri(String fileName) {
        ...
        Log.i("EDMM", "Path: " + file.getAbsolutePath());
        return file;
    }
}